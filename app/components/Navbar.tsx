...
export default function Navbar() {
    ...
    // 3. Logo Logic
    const logoTextMain = isScrolled ? "text-blue-900" : "text-white";
    const logoTextAccent = isScrolled ? "text-blue-600" : "text-blue-400";

    // 4. Phone Icon Logic
    const phoneIconColor = isScrolled ? "text-gray-600" : "text-blue-200";
    const phoneTextColor = isScrolled ? "text-gray-600" : "text-white/90";
